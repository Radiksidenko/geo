System.register(["@angular/router", "./dashboard/dash.component", "./user-profile/user-profile.component", "./chat/chat.component", "./user_list/user_list.component"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var router_1, dash_component_1, user_profile_component_1, chat_component_1, user_list_component_1, routes, routing;
    return {
        setters: [
            function (router_1_1) {
                router_1 = router_1_1;
